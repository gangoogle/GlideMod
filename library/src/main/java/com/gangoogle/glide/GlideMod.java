...
import com.gangoogle.glide.load.data.InputStreamRewinder;
...
import com.gangoogle.glide.load.engine.prefill.BitmapPreFiller;
import com.gangoogle.glide.load.engine.prefill.PreFillType;
import com.gangoogle.glide.load.engine.prefill.PreFillType.Builder;
import com.gangoogle.glide.load.model.AssetUriLoader;
import com.gangoogle.glide.load.model.ByteArrayLoader;
import com.gangoogle.glide.load.model.ByteBufferEncoder;
import com.gangoogle.glide.load.model.ByteBufferFileLoader;
import com.gangoogle.glide.load.model.DataUrlLoader;
import com.gangoogle.glide.load.model.FileLoader;
import com.gangoogle.glide.load.model.GlideUrl;
import com.gangoogle.glide.load.model.MediaStoreFileLoader;
import com.gangoogle.glide.load.model.ResourceLoader;
import com.gangoogle.glide.load.model.StreamEncoder;
import com.gangoogle.glide.load.model.StringLoader;
import com.gangoogle.glide.load.model.UnitModelLoader;
import com.gangoogle.glide.load.model.UriLoader;
import com.gangoogle.glide.load.model.UrlUriLoader;
import com.gangoogle.glide.load.model.stream.HttpGlideUrlLoader;
import com.gangoogle.glide.load.model.stream.HttpUriLoader;
import com.gangoogle.glide.load.model.stream.MediaStoreImageThumbLoader;
import com.gangoogle.glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.gangoogle.glide.load.model.stream.UrlLoader;
import com.gangoogle.glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.gangoogle.glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.gangoogle.glide.load.resource.bitmap.BitmapEncoder;
import com.gangoogle.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.gangoogle.glide.load.resource.bitmap.ByteBufferBitmapImageDecoderResourceDecoder;
import com.gangoogle.glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.gangoogle.glide.load.resource.bitmap.Downsampler;
import com.gangoogle.glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.gangoogle.glide.load.resource.bitmap.InputStreamBitmapImageDecoderResourceDecoder;
import com.gangoogle.glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.gangoogle.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.gangoogle.glide.load.resource.bitmap.UnitBitmapDecoder;
import com.gangoogle.glide.load.resource.bitmap.VideoDecoder;
import com.gangoogle.glide.load.resource.bytes.ByteBufferRewinder;
import com.gangoogle.glide.load.resource.drawable.ResourceDrawableDecoder;
import com.gangoogle.glide.load.resource.drawable.UnitDrawableDecoder;
import com.gangoogle.glide.load.resource.file.FileDecoder;
import com.gangoogle.glide.load.resource.gif.ByteBufferGifDecoder;
import com.gangoogle.glide.load.resource.gif.GifDrawable;
import com.gangoogle.glide.load.resource.gif.GifDrawableEncoder;
import com.gangoogle.glide.load.resource.gif.GifFrameResourceDecoder;
import com.gangoogle.glide.load.resource.gif.StreamGifDecoder;
import com.gangoogle.glide.load.resource.transcode.BitmapBytesTranscoder;
import com.gangoogle.glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.gangoogle.glide.load.resource.transcode.DrawableBytesTranscoder;
import com.gangoogle.glide.load.resource.transcode.GifDrawableBytesTranscoder;
import com.gangoogle.glide.manager.ConnectivityMonitorFactory;
import com.gangoogle.glide.manager.RequestManagerRetriever;
import com.gangoogle.glide.module.ManifestParser;
 ...
 * com.gangoogle.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class GlideMod implements ComponentCallbacks2 {
    ...
    private static void initializeGlide(
        ...
        List<com.gangoogle.glide.module.GlideModule> manifestModules = Collections.emptyList();
        ...
        if (annotationGeneratedModule != null
            ...
            Iterator<com.gangoogle.glide.module.GlideModule> iterator = manifestModules.iterator();
            while (iterator.hasNext()) {
                com.gangoogle.glide.module.GlideModule current = iterator.next();
        ...
        if (Log.isLoggable(TAG, Log.DEBUG)) {
            for (com.gangoogle.glide.module.GlideModule glideModule : manifestModules) {
        ...
        for (com.gangoogle.glide.module.GlideModule module : manifestModules) {
        ...
        try {
            Class<GeneratedAppGlideModule> clazz =
                    (Class<GeneratedAppGlideModule>)
                            Class.forName("com.gangoogle.glide.GeneratedAppGlideModuleImpl");
    ...
    /**
     * Returns the {@link com.gangoogle.glide.load.engine.bitmap_recycle.BitmapPool} used to
     ...
     * com.gangoogle.glide.load.ResourceDecoder}s and {@link com.gangoogle.glide.load.Transformation}s.
