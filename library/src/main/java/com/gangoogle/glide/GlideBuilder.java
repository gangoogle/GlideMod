...
import com.gangoogle.glide.GlideMod.RequestOptionsFactory;
...
import com.gangoogle.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.gangoogle.glide.load.engine.cache.DiskCache;
import com.gangoogle.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.gangoogle.glide.load.engine.cache.LruResourceCache;
import com.gangoogle.glide.load.engine.cache.MemoryCache;
import com.gangoogle.glide.load.engine.cache.MemorySizeCalculator;
import com.gangoogle.glide.load.engine.executor.GlideExecutor;
import com.gangoogle.glide.manager.ConnectivityMonitorFactory;
import com.gangoogle.glide.manager.DefaultConnectivityMonitorFactory;
import com.gangoogle.glide.manager.RequestManagerRetriever;
import com.gangoogle.glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link com.gangoogle.glide.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link com.gangoogle.glide.load.engine.cache.MemoryCache} implementation to store
   * {@link com.gangoogle.glide.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link com.gangoogle.glide.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link com.gangoogle.glide.load.engine.cache.DiskCache} to use to store {@link
   * com.gangoogle.glide.load.engine.Resource} data on disk.
   *
   ...
   * com.gangoogle.glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving {@link
   * com.gangoogle.glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link com.gangoogle.glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link com.gangoogle.glide.load.resource.gif.GifDrawable} or {@link
  ...
  /**
   * Sets the {@link com.gangoogle.glide.manager.ConnectivityMonitorFactory} to use to notify {@link
   * com.gangoogle.glide.RequestManager} of connectivity events. If not set {@link
   * com.gangoogle.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
   ...
   * com.gangoogle.glide.request.target.Target}s which are subsequently de-referenced and garbage
   ...
   * load resources into {@link com.gangoogle.glide.request.target.Target}s and then never clear the
   * {@link com.gangoogle.glide.request.target.Target}. To do so, Glide uses {@link
   * java.lang.ref.WeakReference}s to track resources that belong to {@link
   * com.gangoogle.glide.request.target.Target}s that haven't yet been cleared. Setting this method
   * to {@code true} allows Glide to also maintain a hard reference to the underlying resource so
   * that if the {@link com.gangoogle.glide.request.target.Target} is garbage collected, Glide can
   ...
   * resources into {@link com.gangoogle.glide.request.target.Target}s but never clear them.
   *
   ...
   * com.gangoogle.glide.request.target.Target} used to load the {@link Bitmap}. However, if you set
   ...
   * com.gangoogle.glide.request.target.Target}s when you're done with the corresponding resource.
   * Clearing {@link com.gangoogle.glide.request.target.Target}s allows Glide to maximize resource
   ...
   * com.gangoogle.glide.load.engine.GlideException#setOrigin(Exception)} for failed requests.
   *
   ...
   * com.gangoogle.glide.load.resource.bitmap.Downsampler} and {@link android.graphics.BitmapFactory}
   ...
   * may still be used as part of {@link com.gangoogle.glide.load.Transformation}s because {@link
   * android.graphics.ImageDecoder} does not support Bitmap re-use.
   *
   * <p>When this flag is enabled {@link
   * com.gangoogle.glide.load.resource.bitmap.Downsampler#FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS} is
   * ignored. All other {@link com.gangoogle.glide.load.resource.bitmap.Downsampler} flags are
