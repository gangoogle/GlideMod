...
import static com.gangoogle.glide.request.RequestOptions.decodeTypeOf;
...
import com.gangoogle.glide.manager.ConnectivityMonitor;
import com.gangoogle.glide.manager.ConnectivityMonitorFactory;
import com.gangoogle.glide.manager.Lifecycle;
import com.gangoogle.glide.manager.LifecycleListener;
import com.gangoogle.glide.manager.RequestManagerTreeNode;
import com.gangoogle.glide.manager.RequestTracker;
import com.gangoogle.glide.manager.TargetTracker;
...
import com.gangoogle.glide.request.target.CustomViewTarget;
...
public class RequestManager implements LifecycleListener, ModelTypes<RequestBuilder<Drawable>> {
   ...
   * com.gangoogle.glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
  ...
  /**
   * Equivalent to calling {@link #asDrawable()} and then
   *
  ...
  @CheckResult
  @Override
  public RequestBuilder<Drawable> load(@Nullable Bitmap bitmap, BaseKey key) {
    return asDrawable().load(bitmap,key);
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<Drawable> load(@Nullable Drawable drawable, BaseKey key) {
    return asDrawable().load(drawable,key);
  }

  /**
   * Equivalent to calling {@link #asDrawable()} and
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  @NonNull
  @CheckResult
  @Override
  public RequestBuilder<Drawable> load(@Nullable String string, BaseKey key) {
    return asDrawable().load(string,key);
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<Drawable> load(@Nullable Uri uri, BaseKey key) {
    return asDrawable().load(uri,key);
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<Drawable> load(@Nullable File file, BaseKey key) {
    return asDrawable().load(file,key);
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<Drawable> load(@RawRes @DrawableRes @Nullable Integer resourceId, BaseKey key) {
    return asDrawable().load(resourceId,key);
  }
  ...
  @Override
  @Deprecated
  public RequestBuilder<Drawable> load(@Nullable URL url, BaseKey key) {
    return asDrawable().load(url, key);
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<Drawable> load(@Nullable byte[] model, BaseKey key) {
    return asDrawable().load(model,key);
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<Drawable> load(@Nullable Object model, BaseKey key) {
    return asDrawable().load(model,key);
  }
   ...
   * com.gangoogle.glide.load.engine.DiskCacheStrategy#DATA}. As a result, specifying a {@link
   * com.gangoogle.glide.load.engine.DiskCacheStrategy} on this request is generally not recommended.
   *
  ...
  @NonNull
  @CheckResult
  public RequestBuilder<File> download(@Nullable Object model, BaseKey key) {
    return downloadOnly().load(model,key);
  }
   ...
   * com.gangoogle.glide.load.ResourceDecoder}s that can decode the given resource class or any
