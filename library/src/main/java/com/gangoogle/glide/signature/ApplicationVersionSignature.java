...
/**
 * A utility class for obtaining a {@link com.gangoogle.glide.load.Key} signature containing the
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link com.gangoogle.glide.load.Key} for version code of the Application
