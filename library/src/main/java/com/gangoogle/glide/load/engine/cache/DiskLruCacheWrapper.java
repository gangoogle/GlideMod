...
import com.gangoogle.glide.disklrucache.DiskLruCache;
import com.gangoogle.glide.disklrucache.DiskLruCache.Value;
...
public class DiskLruCacheWrapper implements DiskCache {
  ...
  public File get(BaseKey key) {
    String safeKey = safeKeyGenerator.getSafeKey(key.getKey());
