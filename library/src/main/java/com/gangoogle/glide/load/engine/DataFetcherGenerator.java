...
/**
 * Generates a series of {@link com.gangoogle.glide.load.data.DataFetcher DataFetchers} using
 * registered {@link com.gangoogle.glide.load.model.ModelLoader ModelLoaders} and a model.
 */
interface DataFetcherGenerator {
  /**
   * Called when the generator has finished loading data from a {@link
   * com.gangoogle.glide.load.data.DataFetcher}.
   */
  ...
  /**
   * Attempts to a single new {@link com.gangoogle.glide.load.data.DataFetcher} and returns true if a
   * {@link com.gangoogle.glide.load.data.DataFetcher} was started, and false otherwise.
   */
  boolean startNext();
