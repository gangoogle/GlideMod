...
import static com.gangoogle.glide.gifdecoder.GifDecoder.TOTAL_ITERATION_COUNT_FOREVER;
...
public class GifDrawable extends Drawable
   ...
   * @param frameTransformation An {@link com.gangoogle.glide.load.Transformation} that can be
   *     applied to each frame.
   * @param targetFrameWidth The desired width of the frames displayed by this drawable (the width
   *     of the view or {@link com.gangoogle.glide.request.target.Target} this drawable is being
   *     loaded into).
   * @param targetFrameHeight The desired height of the frames displayed by this drawable (the
   *     height of the view or {@link com.gangoogle.glide.request.target.Target} this drawable is
   *     being loaded into).
   * @param gifDecoder The decoder to use to decode GIF data.
   * @param firstFrame The decoded and transformed first frame of this GIF.
   * @see #setFrameTransformation(com.gangoogle.glide.load.Transformation, android.graphics.Bitmap)
