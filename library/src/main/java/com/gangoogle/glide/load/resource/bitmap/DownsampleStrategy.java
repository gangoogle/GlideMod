 ...
 * differ depending on the {@link com.gangoogle.glide.load.ResourceDecoder} using the strategy and
 ...
 * com.gangoogle.glide.load.Transformation} either instead or in addition to a {@code
 * DownsampleStrategy}.
 *
 * <p>Some differences between versions of Android and {@link
 * com.gangoogle.glide.load.ResourceDecoder}s are listed below, but the list is not comprehensive
 ...
 * is supported. To preserve the potential for a {@link com.gangoogle.glide.load.Transformation} to
