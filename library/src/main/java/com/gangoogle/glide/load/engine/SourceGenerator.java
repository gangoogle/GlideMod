...
/**
 * Generates {@link com.gangoogle.glide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link com.gangoogle.glide.load.model.ModelLoader ModelLoaders} and the model
...
class SourceGenerator
  ...
  SourceGenerator(DecodeHelper<?> helper, FetcherReadyCallback cb,BaseKey baseKey) {
    this.helper = helper;
    this.cb = cb;
  ...
  private void cacheData(Object dataToCache) {
    ...
    try {
      ...
      helper.getDiskCache().put(baseKey, writer);
    ...
    sourceCacheGenerator =
        new DataCacheGenerator(Collections.singletonList(loadData.sourceKey), helper, this,baseKey);
  }
