...
/**
 * An {@link com.gangoogle.glide.load.model.ModelLoader} for translating {@link
 * com.gangoogle.glide.load.model.GlideUrl} (http/https URLS) into {@link java.io.InputStream} data.
 */
// Public API.
