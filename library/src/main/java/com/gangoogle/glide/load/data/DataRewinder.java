...
public interface DataRewinder<T> {
   ...
   * com.gangoogle.glide.load.data.DataRewinder}s.
   *
   * @param <T> The type of data that the {@link com.gangoogle.glide.load.data.DataRewinder} will
   *     wrap.
   */
  interface Factory<T> {
    /** Returns a new {@link com.gangoogle.glide.load.data.DataRewinder} wrapping the given data. */
    @NonNull
    DataRewinder<T> build(@NonNull T data);

    /**
     * Returns the class of data this factory can produce {@link
     * com.gangoogle.glide.load.data.DataRewinder}s for.
     */
    @NonNull
