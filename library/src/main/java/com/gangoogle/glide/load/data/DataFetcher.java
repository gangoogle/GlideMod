 ...
 * com.gangoogle.glide.load.model.ModelLoader}. {@link #loadData(com.gangoogle.glide.Priority,
 * com.gangoogle.glide.load.data.DataFetcher.DataCallback)} may or may not be called for any given
 * load depending on whether or not the corresponding resource is cached. Cancel also may or may not
 * be called. If {@link #loadData(com.gangoogle.glide.Priority,
 * com.gangoogle.glide.load.data.DataFetcher.DataCallback)}} is called, then so {@link #cleanup()}
 * will be called.
 *
...
public interface DataFetcher<T> {
   ...
   * finally block after the data provided by {@link #loadData(com.gangoogle.glide.Priority,
   * com.gangoogle.glide.load.data.DataFetcher.DataCallback)} has been decoded by the {@link
   * com.gangoogle.glide.load.ResourceDecoder}.
   *
   * <p>Note - this method will be run on a background thread so blocking I/O is safe.
   */
  void cleanup();
  ...
  /** Returns the {@link com.gangoogle.glide.load.DataSource} this fetcher will return data from. */
  @NonNull
