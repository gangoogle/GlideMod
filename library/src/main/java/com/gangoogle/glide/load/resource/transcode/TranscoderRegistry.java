...
/**
 * A class that allows {@link com.gangoogle.glide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link com.gangoogle.glide.load.resource.transcode.ResourceTranscoder} using
   ...
   * com.gangoogle.glide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
