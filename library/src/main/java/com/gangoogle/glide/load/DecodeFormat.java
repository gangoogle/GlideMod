 ...
 * android.graphics.Bitmap}s returned by {@link com.gangoogle.glide.load.ResourceDecoder}s.
 *
 * <p>Note - In some cases it may not be possible to obey the requested setting, not all {@link
 * com.gangoogle.glide.load.resource.bitmap.Downsampler}s support setting formats and certain images
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.gangoogle.glide.load.ResourceDecoder}. should return {@link
   ...
   * use {@link com.gangoogle.glide.request.RequestOptions#disallowHardwareConfig()}.
   *
