...
public final class GlideExecutor implements ExecutorService {
   ...
   * and the {@link
   * com.gangoogle.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT}
   ...
   * #calculateBestThreadCount()}, the {@link #DEFAULT_DISK_CACHE_EXECUTOR_NAME} thread name prefix,
   * and a custom {@link
   * com.gangoogle.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy} uncaught
   * throwable strategy.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
   * @param uncaughtThrowableStrategy The {@link
   *     com.gangoogle.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy} to use to
   ...
   * com.gangoogle.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
