...
public abstract class DiskCacheStrategy {
   ...
   * com.gangoogle.glide.load.data.DataFetcher} and the {@link
   * com.gangoogle.glide.load.EncodeStrategy} of the {@link com.gangoogle.glide.load.ResourceEncoder}
   * (if an {@link com.gangoogle.glide.load.ResourceEncoder} is available).
   */
   ...
   *     com.gangoogle.glide.load.ResourceEncoder} will use to encode the resource.
   */
