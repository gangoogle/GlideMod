...
/**
 * For a given {@link com.gangoogle.glide.load.data.DataFetcher} for a given data class, attempts to
 * fetch the data and then run it through one or more {@link
 * com.gangoogle.glide.load.engine.DecodePath}s.
 *
 ...
 *     {@link com.gangoogle.glide.load.engine.DecodePath}s.
