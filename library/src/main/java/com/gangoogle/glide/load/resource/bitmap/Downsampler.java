...
import com.gangoogle.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
    ...
    /**
     * Indicates the {@link com.gangoogle.glide.load.DecodeFormat} that will be used in conjunction
    ...
    /**
     * Indicates the {@link com.gangoogle.glide.load.resource.bitmap.DownsampleStrategy} option that
     ...
     * com.gangoogle.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
     *
     ...
     * provided {@link com.gangoogle.glide.load.resource.bitmap.DownsampleStrategy} option.
     *
     ...
     * com.gangoogle.glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match those
    ...
    private static void calculateScaling(
        ...
        //如果是 90度及270交换宽高 glide 这块默认有问题
        if (degreesToRotate == 90 || degreesToRotate == 270) {
            int temp = sourceWidth;
            sourceWidth = sourceHeight;
            sourceHeight = temp;

            int tempA = targetWidth;
