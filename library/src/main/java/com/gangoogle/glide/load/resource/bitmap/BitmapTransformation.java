...
/**
 * A simple {@link com.gangoogle.glide.load.Transformation} for transforming {@link
 * android.graphics.Bitmap}s that abstracts away dealing with {@link
 * com.gangoogle.glide.load.engine.Resource} objects for subclasses.
 *
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
  ...
  public final Resource<Bitmap> transform(
     ...
     * com.gangoogle.glide.request.target.Target#SIZE_ORIGINAL}, this class converts them to be the
     * size of the Bitmap we're going to transform before calling this method.
     *
     * @param pool        A {@link com.gangoogle.glide.load.engine.bitmap_recycle.BitmapPool} that can be used
