...
import com.gangoogle.glide.request.transition.BitmapTransitionFactory;
import com.gangoogle.glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions
   ...
   *
   * @see com.gangoogle.glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see com.gangoogle.glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
