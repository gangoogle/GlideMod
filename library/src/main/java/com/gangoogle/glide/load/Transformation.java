...
public interface Transformation<T> extends Key {
   ...
   * com.gangoogle.glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *     com.gangoogle.glide.request.target.Target#SIZE_ORIGINAL} to indicate the original resource
   *     width.
