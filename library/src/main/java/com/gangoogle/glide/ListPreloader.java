...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  public interface PreloadModelProvider<U> {
     ...
     * com.gangoogle.glide.request.RequestOptions#override(int, int)} to do so.
     *
  ...
  /**
   * Constructor for {@link com.gangoogle.glide.ListPreloader} that accepts interfaces for providing
