...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
  ...
  /**
   * Returns a {@link com.gangoogle.glide.request.RequestOptions} with {@link #encodeQuality(int)}
  ...
  /**
   * Returns a {@link com.gangoogle.glide.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link com.gangoogle.glide.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @NonNull
