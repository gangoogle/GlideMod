 ...
 * com.gangoogle.glide.RequestBuilder#into(ImageView)}, a subclass of {@link ImageViewTarget}, or
...
public abstract class CustomTarget<T> implements Target<T> {
   ...
   * {@link com.gangoogle.glide.request.RequestOptions#override(int)}. In all other cases, prefer
   ...
   * com.gangoogle.glide.request.RequestOptions#override(int)} in the request).
   *
