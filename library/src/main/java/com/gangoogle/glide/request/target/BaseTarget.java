...
/**
 * A base {@link Target} for loading {@link com.gangoogle.glide.load.engine.Resource}s that provides
 ...
 * {@link com.gangoogle.glide.load.engine.Resource} loaded into it using {@link
 * com.gangoogle.glide.RequestManager#clear(Target)}.
 *
 * <p>For loading {@link com.gangoogle.glide.load.engine.Resource}s into {@link android.view.View}s,
 * {@link com.gangoogle.glide.request.target.ViewTarget} or {@link
 * com.gangoogle.glide.request.target.ImageViewTarget} are preferable.
 *
