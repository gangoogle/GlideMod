...
import com.gangoogle.glide.load.resource.bitmap.CenterInside;
...
import com.gangoogle.glide.load.resource.bitmap.DrawableTransformation;
import com.gangoogle.glide.load.resource.bitmap.FitCenter;
import com.gangoogle.glide.load.resource.bitmap.VideoDecoder;
import com.gangoogle.glide.load.resource.gif.GifDrawable;
import com.gangoogle.glide.load.resource.gif.GifDrawableTransformation;
import com.gangoogle.glide.load.resource.gif.GifOptions;
import com.gangoogle.glide.signature.EmptySignature;
import com.gangoogle.glide.util.CachedHashCodeArrayMap;
 ...
 * com.gangoogle.glide.RequestBuilder}.
 *
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.gangoogle.glide.request.target.Target}'s size before
   ...
   *     com.gangoogle.glide.request.target.Target}'s dimensions when loading the resource.
  ...
  /**
   * Overrides the {@link com.gangoogle.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.gangoogle.glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * com.gangoogle.glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  @NonNull
  @CheckResult
   ...
   * com.gangoogle.glide.load.model.stream.HttpGlideUrlLoader}. If you use any other networking
   * library including Glide's Volley or OkHttp integration libraries, this option will be ignored.
   *
   * @see com.gangoogle.glide.load.model.stream.HttpGlideUrlLoader#TIMEOUT
  ...
  /**
   * Applies {@link com.gangoogle.glide.load.resource.bitmap.CenterCrop} to all default types, and
  ...
  /**
   * Applies {@link com.gangoogle.glide.load.resource.bitmap.CenterInside} to all default types,
   ...
   * com.gangoogle.glide.load.resource.gif.GifDrawable}) and throws an exception if asked to
   ...
   * Applies the given {@link Transformation} for {@link Bitmap Bitmaps} to the default types
   * ({@link Bitmap}, {@link android.graphics.drawable.BitmapDrawable}, and {@link
   * com.gangoogle.glide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param transformation Any {@link Transformation} for {@link Bitmap}s.
   ...
   * com.gangoogle.glide.TransitionOptions#dontTransition()}
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
  @NonNull
