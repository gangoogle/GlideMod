...
import com.gangoogle.glideMod.R;
...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
   ...
   * com.gangoogle.glide.request.Request}.
   */
  @Override
  @Nullable
   ...
   * versions, be sure to call {@link com.gangoogle.glide.RequestManager#clear(View)} on any view you
