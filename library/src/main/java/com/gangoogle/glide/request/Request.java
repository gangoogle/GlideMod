...
/** A request that loads a resource for an {@link com.gangoogle.glide.request.target.Target}. */
public interface Request {
   ...
   * com.gangoogle.glide.request.target.Target}s (for example). Using a similar but different method
