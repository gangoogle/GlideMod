...
/**
 * A simple {@link com.gangoogle.glide.request.target.Target} base class with default (usually no-op)
 ...
 * to the previous instance and either call {@link com.gangoogle.glide.RequestManager#clear(Target)}
 * on the old instance before starting a new load or you must re-use the old instance for the new
 * load. Glide's {@link com.gangoogle.glide.RequestBuilder#into(Target)} method returns the {@link
 ...
 * calling {@link com.gangoogle.glide.RequestManager#clear(Target)} and you should always null out
