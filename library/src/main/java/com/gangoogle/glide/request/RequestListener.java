...
public interface RequestListener<R> {
   ...
   * use {@link com.gangoogle.glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, com.gangoogle.glide.request.transition.Transition)}.
   *
   * <p>For threading guarantees, see the class comment.
   *
