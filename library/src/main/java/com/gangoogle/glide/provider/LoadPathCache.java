package com.gangoogle.glide.provider;
...
import com.gangoogle.glide.load.resource.transcode.UnitTranscoder;
import com.gangoogle.glide.util.MultiClassKey;
import java.util.Collections;
import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available {@link
 * com.gangoogle.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
