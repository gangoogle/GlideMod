...
import com.gangoogle.glide.request.transition.NoTransition;
import com.gangoogle.glide.request.transition.TransitionFactory;
import com.gangoogle.glide.request.transition.ViewAnimationFactory;
import com.gangoogle.glide.request.transition.ViewPropertyAnimationFactory;
import com.gangoogle.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<
   ...
   *
   * @param animator The {@link com.gangoogle.glide.request.transition.ViewPropertyTransition
   *     .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * com.gangoogle.glide.request.transition.Transition} for each request started with these {@code
   * TransitionOptions}.
   *
   * @return This request builder.
   */
