...
import static com.gangoogle.glide.request.RequestOptions.diskCacheStrategyOf;
import static com.gangoogle.glide.request.RequestOptions.signatureOf;
import static com.gangoogle.glide.request.RequestOptions.skipMemoryCacheOf;
...
import com.gangoogle.glide.request.ErrorRequestCoordinator;
import com.gangoogle.glide.request.FutureTarget;
import com.gangoogle.glide.request.Request;
import com.gangoogle.glide.request.RequestCoordinator;
import com.gangoogle.glide.request.RequestFutureTarget;
...
import com.gangoogle.glide.request.ThumbnailRequestCoordinator;
import com.gangoogle.glide.request.target.PreloadTarget;
import com.gangoogle.glide.request.target.Target;
import com.gangoogle.glide.request.target.ViewTarget;
import com.gangoogle.glide.signature.ApplicationVersionSignature;
import com.gangoogle.glide.util.Executors;
 ...
 *                        com.gangoogle.glide.request.target.Target}.
 */
// Public API.
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
   ...
   * com.gangoogle.glide.load.model.ModelLoader}, {@link com.gangoogle.glide.load.ResourceDecoder},
   * and {@link com.gangoogle.glide.load.Transformation}s. However, {@link
   * com.gangoogle.glide.request.RequestOptions#placeholder(int)} and {@link
   * com.gangoogle.glide.request.RequestOptions#error(int)}, and {@link #listener(RequestListener)}
   ...
   * by default, consider registering a custom {@link com.gangoogle.glide.load.model.ModelLoader} or
   * {@link com.gangoogle.glide.load.ResourceDecoder} instead of using this method.
   *
  ...
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@Nullable Bitmap bitmap, BaseKey key) {
    return loadGeneric(bitmap, key).apply(diskCacheStrategyOf(DiskCacheStrategy.NONE));
  }
   ...
   * com.gangoogle.glide.load.model.ModelLoader} or {@link com.gangoogle.glide.load.ResourceDecoder}
  ...
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@Nullable Drawable drawable, BaseKey key) {
    return loadGeneric(drawable, key).apply(diskCacheStrategyOf(DiskCacheStrategy.NONE));
  }
   ...
   * com.gangoogle.glide.request.RequestOptions#signature(com.gangoogle.glide.load.Key)} to mixin a
   ...
   * com.gangoogle.glide.load.engine.DiskCacheStrategy#NONE} and/or {@link
   * com.gangoogle.glide.request.RequestOptions#skipMemoryCache(boolean)} may be appropriate.
   *
   * @param string A file path, or a uri or url handled by {@link com.gangoogle.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
  public RequestBuilder<TranscodeType> load(@Nullable String string, BaseKey key) {
    return loadGeneric(string, key);
  }
   ...
   * data changes. Alternatively, using {@link com.gangoogle.glide.load.engine.DiskCacheStrategy#NONE}
   * and/or {@link com.gangoogle.glide.request.RequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   *
   * @param uri The Uri representing the image. Must be of a type handled by {@link
   *            com.gangoogle.glide.load.model.UriLoader}.
   */
  @NonNull
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@Nullable Uri uri, BaseKey key) {
    return loadGeneric(uri, key);
  }
   ...
   * expect the data in the File to change, Consider using {@link com.gangoogle.glide.request.RequestOptions#signature(com.gangoogle.glide.load.Key)}
  ...
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@Nullable File file, BaseKey key) {
    return loadGeneric(file, key);
  }

  /**
   * Returns a request builder that uses the {@link com.gangoogle.glide.load.model.ModelLoaderFactory}
   * currently registered or {@link Integer} to load the image represented by the given {@link
   * Integer} resource id. Defaults to {@link com.gangoogle.glide.load.model.ResourceLoader} to load
   * resource id models.
   *
   ...
   * using {@link com.gangoogle.glide.load.engine.DiskCacheStrategy#NONE} via {@link
   * RequestOptions#diskCacheStrategy(com.gangoogle.glide.load.engine.DiskCacheStrategy)} during
   * development, and re-enabling the default {@link com.gangoogle.glide.load.engine.DiskCacheStrategy#RESOURCE}
   * for release builds.
   *
   ...
   * com.gangoogle.glide.load.Transformation}s to these {@link Drawable}s by either extracting the
   ...
   * transformed (other than {@link com.gangoogle.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   * method, especially in conjunction with {@link com.gangoogle.glide.load.Transformation}s with
   * caution for non-{@link Bitmap} {@link Drawable}s.
   *
   * @see com.gangoogle.glide.signature.ApplicationVersionSignature
   */
  @NonNull
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@RawRes @DrawableRes @Nullable Integer resourceId,
      BaseKey key) {
    return loadGeneric(resourceId, key)
  ...
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@Nullable URL url, BaseKey key) {
    return loadGeneric(url, key);
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@Nullable byte[] model, BaseKey key) {
    RequestBuilder<TranscodeType> result = loadGeneric(model, key);
   ...
   * @return The {@link com.gangoogle.glide.request.target.Target} used to wrap the given {@link
   * ImageView}.
   * @see RequestManager#clear(Target)
   */
  @NonNull
   ...
   *               overridden by {@link com.gangoogle.glide.request.RequestOptions#override(int,
   ...
   * RequestManager#clear(Target)}.
   * @see com.gangoogle.glide.ListPreloader
   */
  @NonNull
