...
import com.gangoogle.glide.load.Encoder;
...
import com.gangoogle.glide.load.data.DataRewinder;
import com.gangoogle.glide.load.data.DataRewinderRegistry;
import com.gangoogle.glide.load.engine.DecodePath;
import com.gangoogle.glide.load.engine.LoadPath;
...
import com.gangoogle.glide.load.model.ModelLoaderRegistry;
import com.gangoogle.glide.load.resource.transcode.ResourceTranscoder;
import com.gangoogle.glide.load.resource.transcode.TranscoderRegistry;
import com.gangoogle.glide.provider.EncoderRegistry;
import com.gangoogle.glide.provider.ImageHeaderParserRegistry;
import com.gangoogle.glide.provider.LoadPathCache;
import com.gangoogle.glide.provider.ModelToResourceClassCache;
import com.gangoogle.glide.provider.ResourceDecoderRegistry;
import com.gangoogle.glide.provider.ResourceEncoderRegistry;
...
public class Registry {
   ...
   *     {@link com.gangoogle.glide.load.resource.gif.GifDrawable} etc).
   ...
   * com.gangoogle.glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link com.gangoogle.glide.load.data.DataRewinder.Factory} to handle a
  ...
  /**
   * Thrown when no {@link com.gangoogle.glide.load.model.ModelLoader} is registered for a given
   * model class.
   */
