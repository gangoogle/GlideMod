...
/**
 * A view-less used to safely store an {@link
 * com.gangoogle.glide.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets within the fragment or activity this fragment is a child of.
 *
 * @see com.gangoogle.glide.manager.RequestManagerFragment
 * @see com.gangoogle.glide.manager.RequestManagerRetriever
 * @see com.gangoogle.glide.RequestManager
 */
public class SupportRequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.gangoogle.glide.RequestManager}.
   *
  ...
  /** Returns the current {@link com.gangoogle.glide.RequestManager} or null if none is put. */
  @Nullable
  ...
  private void registerFragmentWithRoot(@NonNull FragmentActivity activity) {
    ...
    rootRequestManagerFragment =
        GlideMod.get(activity).getRequestManagerRetriever().getSupportRequestManagerFragment(activity);
